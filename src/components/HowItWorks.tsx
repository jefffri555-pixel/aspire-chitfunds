...
export default function HowItWorks() {
  ...
  return (
    <section ref={sectionRef} className="section-padding bg-cream-ivory relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div key={number} className="reveal relative z-10 group">
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#CFAF5D]/15 hover:border-[#CFAF5D]/40 hover:shadow-gold transition-all duration-400 premium-card h-full">
                <div className="flex items-start justify-between mb-5">
                  ...
                  <span className="font-serif text-5xl font-bold text-[#123524]/8 leading-none">{number}</span>
                </div>
                ...
                <h3 className="font-serif text-xl font-bold text-[#123524] mb-3 group-hover:text-[#1E4A34]">
                  {title}
                </h3>
                <p className="text-[#232323]/60 text-sm leading-relaxed">{desc}</p>
              </div>
        ...
        <div className="text-center mt-14 reveal">
          <p className="text-[#232323]/60 mb-5 text-lg">Ready to start your savings journey?</p>
          <button
