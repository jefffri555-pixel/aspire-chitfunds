...
export default function Knowledge() {
  ...
  return (
    <section id="knowledge" ref={sectionRef} className="section-padding bg-[#082340] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 stagger">
          {articles.map(({ icon: Icon, title, topics, desc }, i) => (
            <div key={i} className="reveal group p-6 rounded-2xl bg-[#082340]/20 border border-[#CFAF5D]/15 hover:bg-[#082340]/40 hover:border-[#CFAF5D]/35 transition-all duration-400 premium-card">
