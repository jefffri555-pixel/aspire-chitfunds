...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-cream-pearl relative overflow-hidden">
      <div className="absolute inset-0 opacity-30"
        style={{ backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(207,175,93,0.1) 0%, transparent 70%)' }}
      />

      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#123524] mb-5 reveal">
          Start Your Financial Growth Journey Today
        </h2>
        <p className="text-[#232323]/70 text-lg leading-relaxed mb-8 max-w-2xl mx-auto reveal">
