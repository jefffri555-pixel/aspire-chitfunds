      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 stagger">
          {features.map(({ icon: Icon, title, desc, tag }, i) => (
            <div
              key={title}
              className="reveal group p-7 rounded-2xl border border-[#CFAF5D]/15 bg-[#082340]/40 hover:bg-[#082340]/60 hover:border-[#CFAF5D]/40 transition-all duration-400 premium-card"
            >
