...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="section-padding bg-[#388087] relative overflow-hidden">
              ...
              {contactInfo.map(({ icon: Icon, label, value, href }, i) => (
                ...
                >
                  <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#388087]/10 to-[#388087]/5 flex items-center justify-center flex-shrink-0 group-hover:from-[#388087]/20 group-hover:to-[#388087]/10 transition-all duration-300">
          ...
          <div className="reveal-right">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-[#CFAF5D]/15">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {error && (
                  <div className="p-4 rounded-xl bg-[#388087]/40 border border-[#CFAF5D]/20">
                ...
                <button
                  ...
                  className="w-full h-14 mt-6 bg-gradient-to-r from-[#388087] to-[#CFAF5D] hover:from-[#388087]/90 hover:to-[#E4C77A] disabled:opacity-70 disabled:cursor-not-allowed text-white font-bold text-base rounded-xl transition-all duration-300 hover:shadow-gold flex items-center justify-center gap-2 group relative overflow-hidden"
                >
