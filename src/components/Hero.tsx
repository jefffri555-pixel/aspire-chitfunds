...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#388087]" />
      <div className="absolute inset-0 bg-gradient-to-b from-[#388087]/80 via-transparent to-[#388087]/90" />
      ...
      <div className="parallax-orb orb absolute top-1/2 left-1/2 w-40 h-40 bg-[#388087]/60 transition-transform duration-300 ease-out" style={{ animationDelay: '4s' }} />
